...
from ..views import POCList, poc_detail, search, poc_create, POCCreate, POCUpdate, POCDelete, NewsLinkCreate, NewsLinkUpdate, NewsLinkDelete, upload
from django.conf.urls.static import static
from django.conf import settings

urlpatterns = [
    url(r'^$', POCList.as_view(), name='nutr_poc_list'),
    url(r'^search/$', search, name='poc_search'),
